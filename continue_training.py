...
if __name__ == '__main__':
	...
	model.load_weights('biaxial_pn_encoder_concat_deeplstm.h5')
	model.compile(loss = my_binary_loss_seq, optimizer = Adam(learning_rate=float(args['lear'])))

	model.summary()


	checkpoint_path = 'biaxial_pn_encoder_concat_deeplstm_cont.h5'
	...
	# dd/mm/YY
	filename = 'biaxial_pn_encoder_concat_deeplstm_cont'
